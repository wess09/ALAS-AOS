package com.aliothmoon.azurpilot.settings
...
data class AppSettings(
    /** [com.aliothmoon.azurpilot.domain.RemoteBackend] 的 name */
    ...
    /** [com.aliothmoon.azurpilot.domain.RunMode] 的 name */
    @PrefKey(default = "BACKGROUND")
    val runMode: String = "BACKGROUND",

    /** [com.aliothmoon.azurpilot.domain.OverlayControlMode] 的 name；仅前台模式生效 */
